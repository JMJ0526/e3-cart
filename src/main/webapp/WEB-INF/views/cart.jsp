...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" type="text/css" href="${ctx}/css/jquery.alerts.css?v=20160713" />
<link rel="stylesheet" type="text/css" href="${ctx}/css/head.css?v=20160713" />
<link rel="stylesheet" type="text/css" href="${ctx}/css/cart.css?v=20160630">
<link rel="stylesheet" type="text/css" href="${ctx}/css/common.css?v=201321222" />
<script type="text/javascript" src="${ctx}/js/jquery-1.5.1.min.js?v=20160713"></script>
<script type="text/javascript" src="${ctx}/js/jquery.price_format.2.0.min.js"></script>
<script type="text/javascript" src="${ctx}/js/jquery.alerts.js?v=20160713"></script>
<script type="text/javascript" src="${ctx}/js/cart.js?v=20160713"></script>
 <script type="text/javascript" src="${ctx}/js/cookie.js?v=20160416222"></script>
<script type="text/javascript" src="${ctx}/js/shadow.js?v=20160416"></script>
...
<div class="cartMain">
	...
	<div class="cartMain">
				...
				<div class="cartPInfo" id="danjian-0-229363">
					<div class="clearit">
						...
						<div class="pItem pOperator">
							<a id="cartDel" href="${ctx }/cart/delete/${cart.id}">删除</a>
						</div>
					</div>
		</div>
		</c:forEach>
      ...
      <div class="cartJsuan">
         <input onclick="javascript:document.location.href='http://localhost:10001/e3-front-web/index.html'" class="goshop" value="继续购物" type="button">
         <input onclick="javascript:document.location.href='http://localhost:8086/e3-order/order/order-cart.html'" class="jiesuan youxuan" value="去结算" type="button">
      </div>
    </div>
</div>
<!-- footer start -->
